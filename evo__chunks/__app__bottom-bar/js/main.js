  ...
  constructor(parameters) {
    ...
    this.template = `
        <div class="bottom-bar__select-container">
          ...
          <button class="bottom-bar__select-item button-route">${!isEmptyObj(userStore) ? userStore.store.shortTitle : 'Адрес магазина' || 'Адрес магазина'}
        ...
        <button class="bottom-bar__select-item bottom-bar__select-item--size--small bottom-bar__select-item--type--basket button-route">
